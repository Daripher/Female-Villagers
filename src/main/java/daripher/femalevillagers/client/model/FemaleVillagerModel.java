...
public class FemaleVillagerModel<T extends AbstractVillager> extends VillagerModel<T> implements ArmedModel {
	...
	public static MeshDefinition createBodyModel() {
		...
		var head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4F, -9.8F, -4F, 8F, 10F, 8F, new CubeDeformation(-0.2F)), PartPose.offset(0F, 2.4F, 0F));
		var hat = head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(32, 0).addBox(-4F, -9.8F, -4F, 8F, 10F, 8F, new CubeDeformation(0.3F)), PartPose.ZERO);
	...
	public static LayerDefinition createHairLayer() {
		MeshDefinition meshDefinition = createBodyModel();
		var root = meshDefinition.getRoot();
		var head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4F, -9.8F, -4F, 8F, 10F, 8F, new CubeDeformation(-0.1F)), PartPose.offset(0F, 2.4F, 0F));
		head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(32, 0).addBox(-4F, -9.8F, -4F, 8F, 10F, 8F, new CubeDeformation(0.2F)), PartPose.ZERO);
		return LayerDefinition.create(meshDefinition, 64, 64);
	}
